...
class BreedList extends React.Component {
  ...
  render() {
    ...
    keylist.forEach(function(dog) {
      ...
      rows.push(<Breed breed = {breed} id = {id} key = {breed} changeDoggo = {changeDoggo} />);
      });
    rows.push(<Breed breed="random" key="random" id="random" changeDoggo={changeDoggo} />);

    return (
      <div name="Dog Breed List" className="dog-breed-list-container" data-test="dog-breed-list">
      {rows}
